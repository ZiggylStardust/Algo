...
public class Pfeile2 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int n = 0; n < anzahl; n++) {
            ...
            writer.println("ziel: " + ziel + ", wege: " + anzahlWege /*+ "\ndauer: " + dauer / 1e9 + "sec"*/);
            writer.println();
    ...
    public static BigInteger laufschritt(int x, int y, int last) {
        ...
        if (x >= 0 && y >= 0 && x + y <= ziel) {                   //Wenn x oder y negativ sind, ist der weg unmöglich.
            ...
            if (cache[x][y][last] != null) return cache[x][y][last];


            if (y == 0 && x == ziel) {                        //falls das ziel erreicht wird mit 2n schritten
